...
const MESSAGES = {
  ERROR: {
    ...
    JOB_ALREADY_SCHEDULED: {
      statusCode: HTTP_STATUS_CODE.BAD_REQUEST,
      type: "JOB_ALREADY_SCHEDULED",
    },
    INVALID_SCHEDULE_TIME: {
      statusCode: HTTP_STATUS_CODE.BAD_REQUEST,
      type: "INVALID_SCHEDULE_TIME",
    },
    SOCIAL_EMAIL_NOT_FOUND: {
      statusCode: HTTP_STATUS_CODE.BAD_REQUEST,
      type: "SOCIAL_EMAIL_NOT_FOUND",
    },
  },
  SUCCESS: {
    DEFAULT: {
    ...
    SOCIAL_SIGNUP_VERIFICATION: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
        type: "SOCIAL_SIGNUP_VERIFICATION",
        data: data,
      };
    },
    LOGIN: (data) => {
    ...
    GET_JOB_ID_LIST: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
        type: "GET_JOB_ID_LIST",
        data: data,
      };
    },
    SCHEDULE_JOB: (data) => {
    ...
    }, GET_REQ_CATEGORY_LIST: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
        type: "GET_REQ_CATEGORY_LIST",
        data: data,
      };
    },
    CREATE_REPORT: (data) => {
    ...
    JOB_CHAT_DETAILS: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
        type: "JOB_CHAT_DETAILS",
        data: data,
      };
    },
  },
...
const REGEX = {
  ...
  PASSWORD:
    /(?=[^A-Z]*[A-Z])(?=[^a-z]*[a-z])(?=.*[@*%&])(?=[^0-9]*[0-9]).{8,25}/, // NOSONAR // Minimum 8 characters, At least 1 lowercase alphabetical character, At least 1 uppercase alphabetical character, At least 1 numeric character, At least one special character
  COUNTRY_CODE: /^\d{1,4}$/,
...
const PERMISSION_MODULES = {
  ...
  INCIDENTS_DAMAGE: 'Incidents/Damage',
